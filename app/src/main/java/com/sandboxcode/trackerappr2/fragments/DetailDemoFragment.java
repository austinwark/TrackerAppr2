...
public class DetailDemoFragment extends Fragment {
    ...
    private static final String TAG = DetailDemoFragment.class.getSimpleName();
    ...
    public static DetailDemoFragment newInstance(int position, String searchId, ResultModel result) {
